...
MISSION_CONTROL_MODULES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "status": PARTIAL,
        "evidence": ["external_health.py", "test_external_health.py", "admin.html", _route("/api/v1/mission-control/external-services"), _route("/api/v1/mission-control/calyx-backend-telemetry")],
        "tables": [],
